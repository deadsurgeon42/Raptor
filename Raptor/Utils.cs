...
namespace Raptor
{
	...
	public static class Utils
	{
		...
		private static readonly string[] projNames = new string[Main.maxProjectileTypes];

		private static readonly Dictionary<string, Keys> stringToXNAKey = new Dictionary<string, Keys>
		{
			{"\\", Keys.OemBackslash},
		...
		private static readonly Dictionary<Keys, string> xnaKeytoString = new Dictionary<Keys, string>
		{
			{Keys.OemBackslash, "\\"},
			{Keys.OemCloseBrackets, "]"},
			{Keys.OemComma, ","},
		...
		internal static void Initialize()
		{
			...
			for (var i = 0; i < Main.maxProjectileTypes; i++)
			{
				proj.SetDefaults(i);
